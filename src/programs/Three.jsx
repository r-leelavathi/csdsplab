...
const Three = () => {
  ...
  return (
    <div>     
      <Link to='/two'><button>Prev</button></Link>
      <Link to = '/four'><button>Next</button></Link>
       
            <h3>Lab Program 3</h3>
            <h5>Implement Bubble sorting algorithms compute space and time complexities, plot graph using asymptomatic notations
            </h5>
